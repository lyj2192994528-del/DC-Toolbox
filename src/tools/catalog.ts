...
export type ToolPageId = 'terminal' | 'waveform' | 'recording' | 'virtualPort' | 'ble' | 'usb' | 'networkProtocols' | 'baseConverter' | 'checksum' | 'csv' | 'ohms' | 'power' | 'network' | 'capacitors' | 'capconvert' | 'led' | 'opamp' | 'divider'
