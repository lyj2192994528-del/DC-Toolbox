...
- CSV、NamedData、JustFloat 三种实时波形协议，实时显示串口波形【串口波形上位机】
...
- `artifacts/DC Toolbox-1.1.6-x64-Setup.exe`：Windows 安装程序
- `artifacts/DC Toolbox-1.1.6-x64-Portable.exe`：免安装便携版
